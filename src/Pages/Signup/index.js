            ...
            <div className="mainWrap">
              ...
              <form className="mainForm">
                ...
                <div className="pw">
                  ...
                  <div className="pwBox">
                    <label for="pwInput" className="pwLabel">
                      <input
                        id="pwInput"
                        type="password"
                        name="password"
                ...
                <div className="nickname">
                  ...
                  <div className="nicknameBox">
                    <label for="nicknameInput" className="nicknameLabel">
                      <input
                        id="nicknameInput"
                        type="text"
                        name="name"
                ...
                <div className="phone">
                  ...
                  <div className="phoneBox">
                    <label for="phoneInput" className="phoneLabel">
                      <input
                        id="phoneInput"
                        type="text"
                        name="phone"
                ...
                <div className="birthday">
                  <strong className="birthdayTitle">생일/성별</strong>
