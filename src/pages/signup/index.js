...
class Signup extends Component {
  ...
  render() {
    ...
    return (
      <>
        <Head>
          <title>KoKoo Pet Shop | signUp</title>
          <meta name="description" content="KoKoo Pet Shop signUp page" />
          <meta property="og:title" content="KoKoo Pet Shop | signUp" />
          <meta
            property="og:description"
            content="KoKoo Pet Shop sign up page"
          />
